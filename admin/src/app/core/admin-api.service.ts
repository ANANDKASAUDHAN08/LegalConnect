...
export class AdminApiService {
  ...
  getAnnouncements(): Observable<any> { return this.user.getAnnouncements(); }
  ...
  updateResource(id: string, data: any): Observable<any> { return this.content.updateResource(id, data); }
  deleteResource(id: string): Observable<any> { return this.content.deleteResource(id); }
  getHelplines(): Observable<any> { return this.content.getHelplines(); }
  createHelpline(data: any): Observable<any> { return this.content.createHelpline(data); }
  updateHelpline(id: string, data: any): Observable<any> { return this.content.updateHelpline(id, data); }
