/**
 * Geo & Jurisdictional Constants for LegalConnect Administration
 * Comprehensive dataset covering all 28 Indian States & 8 Union Territories
 * with respective administrative districts and judicial divisions.
 */
...
/**
 * Sorted list of all 28 Indian States & 8 Union Territories
 */
export const INDIAN_STATES: readonly string[] = Object.keys(INDIAN_STATES_DISTRICTS).sort((a, b) =>
  a.localeCompare(b)
);

/**
 * Standard list with 'All India' and 'National' options for helpline and registry selectors
 */
export const INDIAN_STATES_WITH_NATIONAL: readonly string[] = [
  'All India',
  'National',
  ...INDIAN_STATES
];
...
/**
 * Get all districts for a given Indian State or UT
 */
...
/**
 * Validate if a given state string is a valid Indian State or Union Territory
 */
export function isValidIndianState(stateName: string): boolean {
  return stateName in INDIAN_STATES_DISTRICTS;
}