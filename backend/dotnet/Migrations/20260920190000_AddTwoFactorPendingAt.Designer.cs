...
namespace CoreApi.Migrations
{
    ...
    [Migration("20260920190000_AddTwoFactorPendingAt")]
    partial class AddTwoFactorPendingAt
    {
        /// <inheritdoc />
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CoreApi.Models.Admin.AdminSavedView", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CoreApi.Models.ContentReport", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CoreApi.Models.InteractionCounter", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CoreApi.Models.Review", b =>
                {
                    ...
                    b.Property<DateTime?>("DisputeRequestedAt")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("CoreApi.Models.ReviewAuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoreApi.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("TwoFactorPendingAt")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("CoreApi.Models.UserBookmark", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CoreApi.Models.UserInteraction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CoreApi.Models.ContentReport", b =>
                {
                    b.HasOne("CoreApi.Models.User", "ReporterUser")
                        .WithMany()
